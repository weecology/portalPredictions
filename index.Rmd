...
This is the forecast for next year's sampling of rodents in the control plots at Portal. The black line indicates the historic total rodent abundance. The blue line indicates the Ensemble model's forecast for total rodent abundances over the next 12 months, along with 95% confidence intervals.
