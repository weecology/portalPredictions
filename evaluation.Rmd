...
species_names = portalr:::full_path('forecasting/PortalData/Rodents/Portal_rodent_species.csv', '~') %>%
...
new_moon_file = portalr:::full_path('forecasting/PortalData/Rodents/moon_dates.csv', '~')
