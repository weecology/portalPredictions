...
species_names = read.csv('PortalData/Rodents/Portal_rodent_species.csv',
...
species_abundance = portalr::abundance(clean=FALSE, shape='flat', level='treatment', 
...
total_abundance = portalr::abundance(clean=FALSE, shape='flat', level='treatment', 
                                     plots="longterm", time='newmoon') %>%
  dplyr::filter(treatment=="control") %>%
