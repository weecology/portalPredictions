...
species_abundance = portalr::abundance(shape='flat', level='treatment', length="longterm") %>%
...
total_abundance = portalr::abundance(shape='flat', level='treatment', length="longterm") %>%
  filter(treatment=="control") %>%
  group_by(period) %>%
